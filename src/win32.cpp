...
// L on the left of string means using unicode encoding, every unicode char will use 2 byte rather than ansi char with 1 byte
#ifdef UNICODE  
...
static void handle_button_message(window_t* window, button_t buttonchar pressed) {
